...
public enum NavigatorScreenType {
    case normal
...
public class Navigator {
    ...
    public static func instance() -> Navigator {
        let navi = Navigator()
        navi.routeBlock = nil
        return navi
    }
    ...
    public func hockRouter(completion: @escaping(UIViewController, UIViewController, NavigatorType, NavigatorScreenType) -> Bool) {
    ...
    public func showURL(_ vc: UIViewController, base: UIViewController?, routerType: NavigatorType, screenType: NavigatorScreenType = .normal) {
        switch routerType {
        case .push, .none:
            push(vc, base: base)
        case .popTo:
...
extension Navigator {
    public func hookURL(_ vc: UIViewController, base: UIViewController, routerType: NavigatorType, screenType: NavigatorScreenType = .normal) {
        var success = false
